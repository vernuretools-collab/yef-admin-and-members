...
import {
  LayoutDashboard, Users, FolderKanban, Handshake,
  BarChart3, Settings, LogOut, Menu, X, Sun, Moon, ChevronRight,
  Calendar, History
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/admin/visitors', icon: Calendar, label: 'Visitors' }
]

export default function AdminLayout({ toggleDark, dark }) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-1 mb-8 mt-1">
        ...
        <div className="min-w-0">
          <div className="text-[11px] text-white/40 uppercase tracking-[0.12em] font-semibold mt-0.5">
            Admin Panel
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 rounded-xl bg-white/8 border border-white/10 p-3.5">
        ...
        <div className="flex gap-2 mt-3">
          <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-[#E31E24]/20 text-white/45 text-[11px] font-semibold uppercase tracking-wide">
            Admin
          </span>
          {user?.memberSince && (
